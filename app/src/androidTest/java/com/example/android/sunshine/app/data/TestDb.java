    ...
    */
    public void testLocationTable() {
       ...
       ContentValues contentValues = TestUtilities.createNorthPoleLocationValues();
        ...
        assertTrue("Error: No Records returned from locatoin query",cursor.moveToFirst());

        TestUtilities.validateCurrentRecord("Error: Location Query Validation Failed",cursor,contentValues);

        assertFalse("Error: MOre than one record retruned from locatoin query",cursor.moveToNext());
        cursor.close();
        db.close();
